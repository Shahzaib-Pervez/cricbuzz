...
void Dashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->scorecardRequested((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->logoutRequested(); break;
        case 2: _t->onNetworkFinished((*reinterpret_cast<std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 3: _t->loadMatches((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->fetchMatchData((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dashboard::*)(const QString & )>(_a, &Dashboard::scorecardRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dashboard::*)()>(_a, &Dashboard::logoutRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void Dashboard::scorecardRequested(const QString & _t1)
{
