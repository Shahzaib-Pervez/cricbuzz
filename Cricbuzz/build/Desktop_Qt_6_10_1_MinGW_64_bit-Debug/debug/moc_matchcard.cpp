/****************************************************************************
** Meta object code from reading C++ file 'matchcard.h'
**
...
#error "The header file 'matchcard.h' doesn't include <QObject>."
...
void MatchCard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->scorecardClicked((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MatchCard::*)(const QString & )>(_a, &MatchCard::scorecardClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void MatchCard::scorecardClicked(const QString & _t1)
{
